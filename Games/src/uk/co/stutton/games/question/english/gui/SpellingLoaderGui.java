 ...
 * 
 */
public class SpellingLoaderGui{
	private JFrame frame = new JFrame("Load Spellings");
...
//	private JPanel topPanel = new JPanel();
	private JLabel lblListId = new JLabel();
	private JLabel lblWeekStartDt = new JLabel();
	private JLabel lblWords = new JLabel();

	private JButton btnSave = new JButton("Save");
	private JButton btnNextList = new JButton("Next");
	private JButton btnPrevList = new JButton("Prev");
	

	public SpellingLoaderGui(SpellingGame game) {
		this.game = game;
		initialiseGui();
	}
